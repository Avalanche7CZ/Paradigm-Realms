...
public final class ForgeProtectionService {
    ...
    private volatile ForgeWildsService wilds;
    private volatile RealmBackupMutationLocks backupLocks;

    public ForgeProtectionService(
    ...
    public void installWilds(ForgeWildsService service) {
