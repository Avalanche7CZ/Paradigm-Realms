...
public final class ForgeCommandPlatform implements CommandPlatform {
    private final CommandDispatcher<ServerCommandSource> dispatcher;

    public ForgeCommandPlatform(CommandDispatcher<ServerCommandSource> dispatcher) {
    ...
    public void register(CommandBuilder root) {
        if (!(root instanceof Builder fabricRoot)
            ...
            throw new IllegalArgumentException("root must be a Forge literal command");
        }
