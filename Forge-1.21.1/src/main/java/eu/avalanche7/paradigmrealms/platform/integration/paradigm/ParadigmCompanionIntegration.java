...
public final class ParadigmCompanionIntegration implements AutoCloseable {
    ...
    public ParadigmCompanionIntegration(
            ForgeRealmRuntime runtime, ForgePermissionGate permissions, MessageRouter messages) {
    ...
    ParadigmCompanionIntegration(
            RealmInspectionService inspection, ForgePermissionGate permissions, MessageRouter messages) {
        this.permissions = permissions;
        this.messages = messages;
        initialize(inspection, Optional.empty());
    }

    private void initialize(RealmInspectionService inspection, Optional<ForgeRealmRuntime> runtime) {
