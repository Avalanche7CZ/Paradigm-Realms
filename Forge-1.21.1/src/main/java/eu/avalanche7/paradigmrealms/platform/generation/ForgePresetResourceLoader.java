...
public final class ForgePresetResourceLoader {
    ...
    public ForgePresetResourceLoader(ResourceManager resources, boolean allowExternalPresets) {
        this(resources, allowExternalPresets, ForgeLoaderServices.getInstance()::isModLoaded, true);
    }

    ForgePresetResourceLoader(
