...
public final class ForgePermissionGate implements CommandPermissionGate {
    private final PermissionService fallback;
    private volatile PermissionService permissions;

    public ForgePermissionGate() {
        this(new Vanilla());
    }

    public ForgePermissionGate(PermissionService permissions) {
