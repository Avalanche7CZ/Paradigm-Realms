...
public final class ForgeProtectionHooks {
    private static volatile ForgeProtectionService service;

    private ForgeProtectionHooks() {}

    public static void install(ForgeProtectionService replacement) {
        service = replacement;
    }
    ...
    public static boolean allowPickup(PlayerEntity player, Entity entity, ProtectionAction action) {
        ForgeProtectionService current = service;
    ...
    public static boolean allowMobGrief(Entity entity, World world, BlockPos position) {
        ...
        if (ForgeProtectionService.responsiblePlayer(entity).isPresent()) return true;
    ...
    public static void filterExplosion(Explosion explosion, World world, BlockPos origin) {
        ...
        if (isWilds(world)) {
            ...
            java.util.Optional<java.util.UUID> wildsActor = ForgeProtectionService.responsiblePlayer(explosion.getEntity());
        ...
        java.util.Optional<java.util.UUID> actor = ForgeProtectionService.responsiblePlayer(explosion.getEntity());
        if (actor.isPresent()) {
