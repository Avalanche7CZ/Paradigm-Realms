...
public final class RealmsConfigLoader {
    ...
    public static RealmsConfig load() {
        return load(ForgeLoaderServices.getInstance().getConfigDir().resolve("paradigm-realms.properties"));
    }
    ...
    public static ValidationResult validate() {
        return validate(ForgeLoaderServices.getInstance().getConfigDir().resolve("paradigm-realms.properties"));
    }
