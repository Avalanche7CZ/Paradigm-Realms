...
public final class FabricBlockStateResolver implements SymbolicBlockStateResolver<BlockState> {
    @Override public Resolution<BlockState> resolve(SymbolicBlockState symbolic) {
        ...
        if (!Registries.BLOCK.containsId(id)) {
            if (!id.getNamespace().equals("minecraft") && !FabricLoader.getInstance().isModLoaded(id.getNamespace())) {
