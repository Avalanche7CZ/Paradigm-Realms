...
import eu.avalanche7.paradigmrealms.platform.generation.importer.FabricBlockStateResolver;
...
public final class FabricRealmPresetGenerator implements RealmGenerationPort {
    ...
    private final FabricBlockStateResolver blockStates = new FabricBlockStateResolver();

    public FabricRealmPresetGenerator(
            MinecraftServer server, FabricPresetCatalogManager presets, ChunkAccessPort chunks) {
        this.server = server;
