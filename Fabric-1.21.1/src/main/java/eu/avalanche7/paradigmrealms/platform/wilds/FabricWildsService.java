...
public final class FabricWildsService {
    ...
    private final FabricRealmRuntime realms;
    ...
    public FabricWildsService(
            MinecraftServer server, FabricRealmRuntime realms, WildsConfig config,
    ...
    private static final class RtpEffects implements WildsRtpPort {
        ...
        private RtpEffects(MinecraftServer server, FabricRealmRuntime realms) {
